    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <h3 class="featurette-heading" style="font-size:18px;text-align:center;">Style ( Outfit of The Day ) OOTD terbaru</h3>
            </div>
                    ...
                    <div class="thumb-inspiration">
                        <div class="thumbnail thumb-content">
                            <a href="details-product-123.html"" onclick="#">
                                <img src="assets/images/product/hijab-jogja-store-pasmina-54hijab-jogja-store--33hijab-jogja-store-hijab-nafa-reviana-6hijaber3.jpg" border="0" class="img-responsive" style="object-fit: cover;" />
                            </a>
                        </div>
                    </div>
                </div>
...
<!--             //for($i=0;$i<12;$i++){    //product -->
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-list-sku">
                    ...
                    <div class="thumbnail box-shadow" style="min-height: 350px; margin: 0 10px 10px 10px; padding: 10px;">
                        <a href="details-product-212.html">
                            <img width="100%" src="assets/images/product/hijab-jogja-store-pasmina-54hijab-jogja-store--33hijab-jogja-store-hijab-nafa-reviana-6hijaber3.jpg" border="0" class="img-responsive" />
                        </a>
                        <div class="caption">
                            <a href="#">

                                <h4 class="product-name text-center small" title="Metthy Top">Hijab Rawis</h4>
...
<div class="row">
    ...
    <div class="col-xs-4 col-sm-4 col-md-2 col-recently-purchased">
        <div class="thumbnail" style="border: none; min-height: 268px; margin-bottom:0px; padding:0px;">
            <a href="details-product-123.html" onClick="#">
                <img width="275px" src="assets/images/product/hijab-jogja-store-pasmina-54hijab-jogja-store--33hijab-jogja-store-hijab-nafa-reviana-6hijaber3.jpg" border="0" class="img-responsive" />
            </a>
            <div class="caption">
                <a href="details-product-123.html" onClick="#">
                    <h4 class="product-name text-center small" title="Leona Turban">Rawias Katun</h4>
                   
                        <h4 class="price text-center">Rp 25.000,-<br><strike class="text-muted"><small>Rp 35.000</small></strike></h4> 
        ...
        <div class="thumbnail" style="border: none; min-height: 268px; margin-bottom:0px; padding:0px;">
            ...
            <div class="caption">
                <a href="details-product-12.html" onClick="#">
                    <h4 class="product-name text-center small" title="Leona Turban">Nama product</h4>
                    <h4 class="price text-center">Rp 25.000,-<br><strike class="text-muted"><small>Rp 35.000,-</small></strike></h4> 
                </a>
            </div>
        </div>
